# komari-agent (Linux monitoring-only fork)

This fork supports Linux only (AMD64 and ARM64 builds), uses the v2 protocol,
and sends credentials exclusively as `Authorization: Bearer`. It provides
